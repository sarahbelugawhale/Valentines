...
import Boyfriend from './assets/IMG_7604.jpeg';
  ...
  return (
    <div className="flex flex-col min-h-screen items-center justify-center">
      ...
      <div className="flex flex-col bg-[#FFF3E6] w-[400px] md:w-[525px] h-[320px] z-0">
        <h1 className="flex items-center justify-center text-center text-4xl w-full h-full">Happy Velentines Day!</h1>
      ...
      <div className="bg-white p-[2vh] rotate-[8deg] z-30 -translate-y-[5vh] md:translate-y-[-8vh] translate-x-[10vh] md:translate-x-[30vh] transition ease-in-out hover:-rotate-[4deg]">
        ...
        <h1 className="text-2xl flex text-center w-full justify-center">Kaley!</h1>
      </div>
    </div>
  );
}
